...
export function mergeViewLists( viewWriter, firstList, secondList ) {
	...
	let secondListAttribute = secondList.getAttribute( 'class' )
	if (firstList.getAttribute( 'class' ) === 'custom-list' &&  !secondList.getAttribute( 'class' )) {
		secondListAttribute = 'custom-list';
	}

	// Both parameters are list elements, so compare types now.
	if ( firstList.name != secondList.name || firstList.getAttribute( 'class' ) !== secondListAttribute  ) {
		return null;
	}
